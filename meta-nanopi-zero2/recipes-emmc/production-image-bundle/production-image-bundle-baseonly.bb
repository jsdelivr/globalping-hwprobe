SUMMARY = "Production WIC image bundle (baseonly variant) for eMMC programming"
DESCRIPTION = "Packages the core-image-minimal-baseonly WIC image for flashing to eMMC"
HOMEPAGE = "https://github.com/jsdelivr/globalping-hwprobe"
SECTION = "base"
LICENSE = "MIT"
LIC_FILES_CHKSUM = "file://${COMMON_LICENSE_DIR}/MIT;md5=0835ade698e0bcf8506ecda2f7b4f302"

# This recipe depends on core-image-minimal-baseonly being built
...
do_install() {
    ...
    WIC_FILE="${DEPLOY_DIR_IMAGE}/core-image-minimal-baseonly-${MACHINE}.rootfs.wic"

    if [ -f "$WIC_FILE" ]; then
        echo "Found production WIC (baseonly): $WIC_FILE"
        ...
        echo "" >> ${D}/opt/images/production.info
        echo "Contains:" >> ${D}/opt/images/production.info
        echo "  - globalping-probe container (frozen image)" >> ${D}/opt/images/production.info
        echo "  - NO CrowdSec IPS" >> ${D}/opt/images/production.info
        echo "  - NO optional containers" >> ${D}/opt/images/production.info
    else
        bbfatal "core-image-minimal-baseonly WIC file not found at $WIC_FILE"
    fi
}
